...
class RangeColorDetector:
    ...
    def returnFiltered(self, frame, morph_opening=False, blur=False, kernel_size=5, iterations=1):
        ...
        #bitwiseAND mask
        filterd_img = cv2.bitwise_and(frame, frame, mask = frame_filtered)
        
        #dilation = cv2.dilate(frame_denoised,kernel,iterations = 2)  
        return filterd_img,frame_filtered

    def returnMask(self, frame, morph_opening=False, blur=False, kernel_size=5, iterations=1):
